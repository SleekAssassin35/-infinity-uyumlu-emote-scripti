...
Citizen.CreateThread(function()
	TriggerEvent('chat:addSuggestion', '/do', 'komutunu kullanabilirsiniz.')
end)
...
function Display(doPlayer, text, offset)
    ...
    Citizen.CreateThread(function()
        ...
        while displaying do
            Wait(0)
            local coordsMe = GetEntityCoords(GetPlayerPed(doPlayer), false)
...
function DrawText3D(x,y,z, text)
  local onScreen, _x, _y = World3dToScreen2d(x, y, z + 0.60) 
